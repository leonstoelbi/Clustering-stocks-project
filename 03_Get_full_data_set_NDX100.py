##### Program 3: Get stock prices of NDX100 and merge data with index/commodity prices
...
stocks = pd.read_csv("NDX100_array.csv", encoding="UTF-8")
...
# ## UNCOMMENT BELOW IF NOT USING PICKLE (for testing, to not download entire dataset from Quandl again)
#
...
#     df1 = quandl.get_table('WIKI/PRICES', date={'gte': start, 'lte': end}, ticker=tickers[:50], paginate=True,
#                            qopts={"columns": ["adj_close", "date", "ticker"]})
#     df2 = quandl.get_table('WIKI/PRICES', date={'gte': start, 'lte': end}, ticker=tickers[50:], paginate=True,
#                            qopts={"columns": ["adj_close", "date", "ticker"]})
#
...
dataset.to_csv('Dataset_complete_NDX100.csv', encoding='UTF-8')